...
from .oregon_trail_specific import GAME_STATES, MEMORY_ADDRESSES
...
class StateMachineAnalyzer:
    ...
    def analyze(self):
        ...
        if not self.game_state_addr:
            print("Warning: Could not find game_state address in memory addresses")
            return
    ...
    def visualize_state_machine(self, output_file: str = "state_machine.png"):
        ...
        pos = nx.spring_layout(self.state_machine, seed=42)  # Consistent layout
